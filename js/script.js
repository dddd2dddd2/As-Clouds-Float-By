...
import { renderViewModeSelect, renderVolumeSelect, renderGenreSelect, applyFilters } from './search.js';
  ...
  try {
    ...
    const startApp = () => {
      ...
      requestAnimationFrame(() => {
        requestAnimationFrame(() => {
          setTimeout(() => document.body.classList.add('fonts-loaded'), 120);
        });
      });
    };
